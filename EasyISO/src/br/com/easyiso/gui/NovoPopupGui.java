...
public class NovoPopupGui extends JDialog implements ActionListener{
	...
	public NovoPopupGui(JFrame chamador){
		this(chamador, "Novo", DEFAULT_W, DEFAULT_H);	}
	
	public NovoPopupGui(JFrame chamador, String name, int x, int y){
		super(chamador, name);
		if (x > 0 && y > 0) {
			super.setSize(x, y);
		} else {
	...
	private void makeForm(){
		...
		pBotoes.add(bFactory.makeButton("Cancelar", "./icons/cancel.png", new actionCancel()) , "split,right, width 100!");
		pBotoes.add(bFactory.makeButton("OK", "./icons/ok.png", new actionOK()) , "width 100!");
	...
	public static void main(String args[]){
		...
		NovoPopupGui n = new NovoPopupGui(null);
		n.setVisible(true);
	}
	...
	private class actionOK implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			try{
				((Command) chamador).execute("novohexa",  fmt.getAreaTcpIp(), inputCodepage);
